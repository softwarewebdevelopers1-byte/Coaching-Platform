...
import { sendSlotRequestReceivedEmail, sendSlotRequestApprovedEmail, sendSlotRequestDeclinedEmail, sendSlotRequestCoachNotificationEmail, } from "../services/Brevo.emailSender.js";
import { programsMatch } from "../utils/programs.js";
const router = Router();
// ── POST create a new slot request (user submits) ────────────────────────────
router.post("/", async (req, res) => {
    const { fullName, email, phoneNumber, programName, coachId, coachName, coachEmail, message, } = req.body;
...
//# sourceMappingURL=SlotRequests.js.map